    ...
    <nav className="fixed top-0 left-0 w-full bg-[#F8F3D9] text-black shadow-md p-4 h-[80px] md:py-[20px] z-50">
      <div className="flex justify-between items-center relative">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/attendance" className="hover:underline">Attendance</Link> {/* ✅ Added Attendance Page Link */}
      ...
      >
        ...
        <Link href="/attendance" className="hover:underline" onClick={() => setMenuOpen(false)}>Attendance</Link> {/* ✅ Added Attendance Page Link */}
